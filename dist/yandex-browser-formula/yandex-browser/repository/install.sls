...
yandex-browser-repository-install-pkgrepo-managed:
  pkgrepo.managed:
    ...
    - require:
      - file: yandex-browser-repository-key-install-file-managed
{%- if cfg.repo.get('required_packages') %}
      - pkg: yandex-browser-repository-package-install-pkg-installed
{%- endif %}
