...
vmware-horizon-client-repository-install-pkgrepo-managed:
  pkgrepo.managed:
    ...
    - require:
      - file: vmware-horizon-client-repository-key-install-file-managed
{%- if cfg.repo.get('required_packages') %}
      - pkg: vmware-horizon-client-repository-package-install-pkg-installed
{%- endif %}
